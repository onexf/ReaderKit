...
public struct ReaderDefaultThemeProvider: ReaderThemeProviding {
    ...
    private static func make(page: UIColor, ink: UIColor) -> ReaderTintAssign {
        ReaderTintAssign(
            ...
            textStrong: ink,
            textBody: ink,
            textSubtle: ink.withAlphaComponent(0.75),
            textFaint: ink.withAlphaComponent(0.55),
            textMuted: ink.withAlphaComponent(0.35),
            iconStandard: ink,
            iconMuted: ink.withAlphaComponent(0.35),
            fillSheet: page,
            fill: ink.withAlphaComponent(0.08),
            fillAccent: ink,
            fillExtreme: ink,
            fillControl: ink.withAlphaComponent(0.12),
            separatorTint: ink.withAlphaComponent(0.15),
            line: ink,
